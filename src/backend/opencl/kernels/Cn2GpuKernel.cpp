...
void xmrig::Cn2GpuKernel::enqueue(cl_command_queue queue, uint32_t nonce, size_t threads)
{
...
void xmrig::Cn2GpuKernel::setArgs(cl_mem scratchpads, cl_mem states, cl_mem output, uint32_t threads)
{
...
void xmrig::Cn2GpuKernel::setTarget(uint64_t target)
{
