...
void xmrig::Cn1GpuKernel::enqueue(cl_command_queue queue, size_t threads, size_t worksize)
{
...
void xmrig::Cn1GpuKernel::setArgs(cl_mem scratchpads, cl_mem states, uint32_t threads)
{
