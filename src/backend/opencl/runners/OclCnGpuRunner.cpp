...
#include "backend/opencl/kernels/Cn00GpuKernel.h"
#include "backend/opencl/kernels/Cn0Kernel.h"
#include "backend/opencl/kernels/Cn1GpuKernel.h"
#include "backend/opencl/kernels/Cn2GpuKernel.h"
...
xmrig::OclCnGpuRunner::OclCnGpuRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
xmrig::OclCnGpuRunner::~OclCnGpuRunner()
{
    delete m_cn00;
    delete m_cn0;
    delete m_cn1;
...
size_t xmrig::OclCnGpuRunner::bufferSize() const
{
...
void xmrig::OclCnGpuRunner::set(const Job &job, uint8_t *blob)
{
...
void xmrig::OclCnGpuRunner::build()
{
    OclBaseRunner::build();

    m_cn00 = new Cn00GpuKernel(m_program);
